...
function QuestionForm() {
  ...
  <div className="AskHeader w-screen h-32 relative">
      ...
      <img className="max-w-md h-25 right-64 top-4 absolute" src={AnswersImg} alt="askPageImg" />
  </div>
  <div className="AskSubForm bg-slate-50 max-w-2xl h-screen ml-64">
      <div className=" bg-sky-50 max-w-2xl h-52 rounded-sm border-sky-200 border">
          <div className="ml-4 absolute top-48">Writing a good question</div> 
              <div className="text-xs ml-4 absolute top-56" >You’re ready to <span className="text-blue-500">ask</span> a <span className="text-blue-500">programming-related question</span> and this form will help guide you through the process. <br/>
          ...
          <span className="text-xs font-medium ml-4 absolute top-[10wh] mt-16">Steps</span><br/>
      ...
      <div className="bg-white max-w-2xl h-24 mt-3 rounded-sm border">
          ...
          <input className='w-[90%] h-6 mt-1 ml-5 rounded-sm text-xs border  ' 
          type='text' 
          placeholder="e.g.Is there an R function for finding the index of an element in a vector?"
          onChange={handlerChangeTitle} value={title}
          />
      </div>
      <div className="bg-white max-w-2xl h-72 mt-3 rounded-sm border">
          ...
          <TextEditor className="h-[15rem] max-w-[60rem] mt-3 ml-4"/>
      </div>
      <div className="bg-white max-w-2xl h-72 mt-3 rounded-sm border">
      ...
      <div className="bg-white max-w-2xl h-36 mt-3 rounded-sm border">
          ...
          <input className='w-[90%] rounded-sm text-xs border h-6 ml-5 mt-3' />
