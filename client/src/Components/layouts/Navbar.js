...
function Navbar() {
  ...
  return (
    <div className="h-100% pt-4 w-11/12 border-r bg-white mt-16 ">
      <ul className="relative">
        ...
        <li className="relative">
          <p className="flex items-center text-sm py-4 px-6 h-10 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap  hover:text-gray-900 hover:bg-gray-200 hover:border-r-4 border-orange-500 transition duration-300 ease-in-out">
